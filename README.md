...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: contain; width: 100vw; opacity: 0.5; background: url('https://raw.githubusercontent.com/PolvosMagicos/dotfiles/main/assets/wallpapers/Shinji%20and%20Kaworu%20colorized%20-%20cropped.jpg');]{x0000}$}
```
